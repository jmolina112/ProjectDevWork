 ...
 * Jacinto Molina
 * class Game- 2332-001
 * Pg 155 Creates a bomb catching Game.
 *
 * + create Game init
 * + create Bomb
 * + create player and user input for player
 * + create GameRun and draw frames
 * + create boundary for player
 * + create shut down function
 */

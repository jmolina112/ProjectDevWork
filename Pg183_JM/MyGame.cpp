 ...
 * class Game- 2332-001
 * Pg 183 
 * Creates an Bomb Exploding Animation.
 *
 * + create Game init and Load the file
 * + create Game Run
 * + create Game End
 * + create DirectX variables
 * + create DirectX fucnctions like init, Shutdown, update
 * + create DirectX Load and draw the Surface
 * + create DirectX Input movement(mouse, keyboard) 
 */
